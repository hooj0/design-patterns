...
|              [空对象 `Null`](./src/behavioral/null-object)              | 通过一个无意义的对象来代替没有对象这个状态<br/>它使得你不用额外对空对象进行处理。 | [Java](./src/behavioral/null-object/java) \| Python \| Go \| JavaScript |
|             [注册 `Registry`](./src/behavioral/registry)             | 跟踪给定类的所有子类                                         | [Java](./src/behavioral/registry/java) \| Python \| Go \| JavaScript |
