...
import io.github.hooj0.factorymethod.support.WeChatMessage;

/**
 * wechat message factory
 * 通过继承抽象消息工厂实现实例化消息对象的业务，在子类中完成产品的创建
 * @author hoojo
 * @createDate 2018年10月6日 下午6:47:53
 * @file WeChatMessageFactory.java
 * @package io.github.hooj0.factorymethod.support.factory
 ...
 * @version 1.0
 */
public class WeChatMessageFactory extends AbstractMessageFactory {
