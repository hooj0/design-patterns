...
/**
 * abstract object pool Generic, <T> Type T of Object in the Pool
 * 
 * @author hoojo
 * @createDate 2018年10月17日 下午8:54:19
 * @file AbstractObjectPool.java
 * @package io.github.hooj0.objectpool.support
...
public abstract class AbstractObjectPool<T> {
	...
	public synchronized String toString() {
		return String.format("Pool available=%d using=%d", availableObjects.size(), usingObjects.size());
	}
}
